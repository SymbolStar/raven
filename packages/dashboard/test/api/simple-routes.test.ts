  ...
  it("success → returns JSON with 200", async () => {
    const data = {
      ...
      counters: {
        ...
        refreshShortCircuitByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshBlockedByCooldown: 0,
        refreshBlockedByCooldownByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshBlockedByMinInterval: 0,
        refreshBlockedByMinIntervalByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshUpstreamCalls: 0,
        refreshUpstreamCallsByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshSucceededTokenUpdated: 0,
        refreshSucceededTokenUpdatedByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshSucceededTokenSame: 0,
        refreshSucceededTokenSameByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
        refreshFailed: 0,
        refreshFailedByReason: { llm401: 0, sentinel401: 0, scheduled: 0, manual: 0 },
