...
const COLUMNS = [
  { key: "key", label: "client", sortable: false }, { key: "count", label: "requests", sortable: true }, { key: "total_tokens", label: "totalTokens", sortable: true }, { key: "input_tokens", label: "input", sortable: true }, { key: "output_tokens", label: "output", sortable: true }, { key: "avg_latency_ms", label: "averageLatency", sortable: true }, { key: "p95_latency_ms", label: "p95Latency", sortable: true }, { key: "error_rate", label: "errorRate", sortable: true }, { key: "last_seen", label: "lastSeen", sortable: true },
...
export function ClientsTable({ data, currentSort, currentOrder }: ClientsTableProps) {
  const { t } = useLocale();
  ...
  const toggleSort = useCallback(
    (col: string) => {
      ...
      if (currentSort === col) {
        params.set("corder", currentOrder === "desc" ? "asc" : "desc");
      } else {
        params.set("csort", col);
        params.set("corder", "desc");
      }
